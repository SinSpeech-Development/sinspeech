...
num_targets=$(tree-info $tree_dir/tree |grep num-pdfs|awk '{print $2}')
  ...
  tdnnf-layer name=tdnnf14 $tdnnf_opts dim=256 bottleneck-dim=80 time-stride=3
  tdnnf-layer name=tdnnf15 $tdnnf_opts dim=256 bottleneck-dim=80 time-stride=3
  tdnnf-layer name=tdnnf16 $tdnnf_opts dim=256 bottleneck-dim=80 time-stride=3
  tdnnf-layer name=tdnnf17 $tdnnf_opts dim=256 bottleneck-dim=80 time-stride=3
